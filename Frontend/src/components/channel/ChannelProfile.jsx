...
function ChannelProfile({ avatar, name, username, subscribers, totalVideos, }) {
    return (
        <section className="flex flex-col items-center -mt-24 relative z-10">
            <img src={avatar} alt={name} className=" h-40 w-40 rounded-full border-4 border-surface object-cover shadow-lg " />
